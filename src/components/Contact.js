...
export const Contact = () =>{
    ...
    const handleSubmit = async (e) =>{
        ...
        // add local host here
        let response = await fetch("https://lucaswyskidevelops.com:5000/contact",{
            method: "POST",
            headers: {
        ...
        if(result.code === 200){
            ...
            setStatus({success: false, message: 'Message did not send at the moment, please try again later!'})
        }
    };
